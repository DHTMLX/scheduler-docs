...
const SITE_NAME = 'DHTMLX Scheduler Docs';
const PRODUCT_NAME = 'DHTMLX Scheduler';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxScheduler/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/scheduler') return 'SoftwareApplication';
