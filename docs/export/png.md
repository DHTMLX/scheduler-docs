...
Starting from version 4.1, dhtmlxScheduler provides an [online export service](export/png.md#default-export-to-png)
...
The [exportToPNG()](api/method/exporttopng.md) method takes as a parameter an object with a number of properties (all the properties are optional):
...
[exportToPNG](export/png.md#parameters-of-the-export-method) method:
