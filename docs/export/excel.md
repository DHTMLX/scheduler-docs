---
title: "Export to Excel and iCal"
sidebar_label: "Export to Excel and iCal"
---
...
~~~
2. Call the <b>exportToExcel</b> method to export the scheduler's data: 
~~~html
...
<table class="webixdoc_links">
  ...
  <td>(<i>array</i>) configures columns of the output sheet <ul> <li>'id' - (string/number) the id of the event's property that will be mapped to the column </li> <li>'header' - (string) the column's header</li> <li>'width' - (number) the column's width in pixels</li> </ul></td>
  </tr>
  <tr>
...
See the date format specification [here](guides/settings-format.md).
