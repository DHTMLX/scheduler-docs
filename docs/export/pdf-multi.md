---
title: "Multi-page export to PDF"
sidebar_label: "Multi-page export to PDF"
---
...
+ _**path**_ - (_url_) the path to the php file which generates a PDF file. See details in chapter ['Export to PDF. Configuring service'](export/pdf.md#using-export-services)
