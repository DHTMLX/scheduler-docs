...
:::note
By default, the left list of the view displays events beginning from the current date. To change such behavior, use the [map_start](api/config/map_start.md), [map_end](api/config/map_end.md) properties.
:::
...
:::note
To use Google Maps, you need to [add your own google API key](https://developers.google.com/maps/documentation/javascript/get-api-key) on your page.
:::
...
You can [change the map provider and its settings](views/map.md#setting-the-map-provider) later on, if needed. The changes will be applied on the next rendering of the map.
...
3. <b>Add the view's tab to the scheduler's markup:</b>
...
2. If necessary, specify the settings via the [map_settings](api/config/map_settings.md) configuration option, e.g.:
...
- via the [map_view_provider](api/config/map_view_provider.md) configuration option:
...
- via the **view_provider** attribute of the [map_settings](api/config/map_settings.md) configuration option:
...
- [map_end](api/config/map_end.md) - sets the date to display events until
- [map_start](api/config/map_start.md) - sets the date to start displaying events from


Starting from v7.1, other map configuration options are specified within the object of the [map_settings](api/config/map_settings.md) property. The default map settings are the 
following:
...
- [scheduler.xy.map_date_width](api/other/xy.md) - the width of the date column
- [scheduler.xy.map_description_width](api/other/xy.md) - the width of the description column
