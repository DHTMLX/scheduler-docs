...
*If you use dhtmlxScheduler 6.0 or earlier, see details [here](views/agenda-legacy.md).*
...
:::note
By default, the left list of the view displays events beginning from the first day of the current month. To change such behavior, use the [agenda_start](api/config/agenda_start.md), [agenda_end](api/config/agenda_end.md) properties or redefine **scheduler.date.agenda_start** and **scheduler.date.agenda_end** functions.
:::
