---
title: "Hiding Time Units in X-Axis of View"
sidebar_label: "Hiding Time Units in X-Axis of View"
---
...
To highlight the place where you hide scale units, use the [addMarkedTimespan](api/method/addmarkedtimespan.md) method. For example, in the Timeline view we preserve hours from 10:00 till 18:00 and hide the remaining ones.
