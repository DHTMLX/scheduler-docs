...
:::warning
 The described functionality is deprecated since version 6.0. Instead of it, define the mode of internal implementation of the code of date formatting methods. [Check the details](api/config/csp.md).
:::
