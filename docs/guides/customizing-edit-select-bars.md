---
title: "Customizing 'Select' and 'Edit' Bars"
sidebar_label: "Customizing 'Select' and 'Edit' Bars"
---
...
By default, the select bar contains 3 buttons ('Details', 'Edit', 'Delete') that are specified by the [icons_select](api/config/icons_select.md) configuration option.
...
-  Redefine [icons_select](api/config/icons_select.md) as in:
...
where **scheduler._click.buttons** contains the collection of onClick handlers for the buttons of the bar. 'location' is the name of the button set in the [icons_edit](api/config/icons_edit.md) after the 'icon_' part.

## The edit bar

Generally, the edit bar contains 2 buttons ('Save' and 'Cancel') that are specified by the [icons_edit](api/config/icons_edit.md) configuration option.
...
-  Redefine [icons_edit](api/config/icons_edit.md) as in:
...
where **scheduler._click.buttons** contains the collection of onClick handlers for the buttons of the bar. 'custom' is the name of the button set in the [icons_edit](api/config/icons_edit.md) after the 'icon_' part.
