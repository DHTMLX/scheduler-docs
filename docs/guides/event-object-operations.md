---
title: "Event Object Operations"
sidebar_label: "Event Object Operations"
---
...
To get the event object, use the [getEvent](api/method/getevent.md) method:
...
To change the current id of an event, you may use the [changeEventId](api/method/changeeventid.md) method as in:
...
The text of an event is specified by one of the following templates: [event_text](api/template/event_text.md) or [event_bar_text](api/template/event_bar_text.md), depending on the type of the view. So to change 
...
- The [serverList](api/method/serverlist.md) method is used to provide options for the combobox and retrieve them inside the template. You can load options together with event data via JSON collections (see [Data formats](guides/data-formats.md#json-with-collections)) and update them later with [updateCollection](api/method/updatecollection.md).
