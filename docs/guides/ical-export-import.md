...
The legacy exporter/importer is PHP-based, so the snippets below are PHP examples. If you are using a different backend, use your platform's iCalendar library and map fields to Scheduler event properties.
