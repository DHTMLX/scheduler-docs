...
To return focus back to Scheduler, you need to use the [focus](api/method/focus.md) method. 
...
To create a new keyboard shortcut, you need to use the [addShortcut](api/method/addshortcut.md) method and pass three parameters to it:
...
To remove a shortcut from the scope, you need to use the [removeShortcut](api/method/removeshortcut.md) method. The method takes two parameters:
...
You can get the handler of the keyboard shorcut with the help of the method [getShortcutHandler](api/method/getshortcuthandler.md). It takes two parameters:
