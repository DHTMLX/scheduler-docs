---
title: "Full List of CDN Links"
sidebar_label: "CDN Links"
---

# Full List of CDN Links

This article lists CDN links for including **dhtmlxScheduler** in your app.

Scheduler consists of two core files:

- **JavaScript:** `dhtmlxscheduler.js`
- **Styles:** `dhtmlxscheduler.css`


## Latest Scheduler version (edge)
...
## Latest Scheduler version (edge), Uncompressed
...
The `[version_number]` specifies `major.minor` version of the package, for example **7.0**, **6.0**, **5.3**, etc. Our CDN always provides the latest patch version for each major/minor release.
