---
title: "Sizing the Scale and Events Boxes"
sidebar_label: "Sizing the Scale and Events Boxes"
---

# Sizing the Scale and Events Boxes 

*If you use dhtmlxScheduler 6.0 or earlier, see details [here](guides/sizing-legacy.md).*
...
+ the default scale unit height is 44px (or the hour height), as defined by [hour_size_px](api/config/hour_size_px.md)
...
It is possible to completely override the render function of the event box. To do so you should use the [renderEvent](api/method/renderevent.md) method that allows you to set your own template for the events:
...
To change the default scale spacing you need to rewrite the [hour_scale](api/template/hour_scale.md) template.
