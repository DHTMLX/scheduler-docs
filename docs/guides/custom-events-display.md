---
title: "Custom Event's Box"
sidebar_label: "Custom Event's Box"
---
...
:::note
Applicable to the [Day View](views/day.md), [Week View](views/week.md) and [Units View](views/units.md) only
:::

## Technique

Customization of events is achieved with the help of the [renderEvent](api/method/renderevent.md) method:
