...
There are two main types of messages: a [simple popup message box](#basic-popup-message) and a [modal message box](#modal-message-boxes) with buttons 
that blocks the work of an application.

A modal message box can belong to one of three possible types:

- [Alert message box](#alert-message-box-alert)
- [Confirm message box](#confirm-message-box-confirm)
- [Modalbox](#modal-box-modal)


## Basic Popup Message 

To create a basic modal message box, use the [scheduler.message](api/method/message.md) method. The obligatory parameter of the method is the text of the message:
...
By default, a popup message box appears in the right top corner of the window. It doesn't prevent the work of the parent application, unlike [modal message boxes](#modal-message-boxes)
...
- [Alert Message Box](#alert-message-box-alert) - an alert box with a button;
- [Confirm Message Box](#confirm-message-box-confirm) - a confirmation box with two buttons (to confirm or to cancel); 
- [Modalbox](#modal-box-modal) - a modal message box with an unlimited number of buttons. 
