---
title: "dhtmlxScheduler with PHP:Slim"
...
:::note
This tutorial uses Slim Framework v4.x.
If you need a tutorial for an older version, check the [Slim Framework v3.x](integrations/other/howtostart-php.md) guide.
:::
