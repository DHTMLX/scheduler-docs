---
title: React Scheduler with Next.js
sidebar_label: Next.js
description: Learn how to integrate DHTMLX React Scheduler with Next.js using the App Router, including client component setup and demo data.
---
