---
title: "dhtmlxScheduler with Node.js"
...
:::note
You should setup your MySQL server, or use some service, e.g. [Free MySQL Hosting](https://www.freemysqlhosting.net/).
:::
...
The above code defines a simple HTML layout, adds sources of dhtmlxScheduler from CDN and initializes scheduler using the [init](api/method/init.md) method.
...
Firstly, enable dynamic loading on the client using the [setLoadMode](api/method/setloadmode.md) method:
...
In order to enable [recurring events](guides/recurring-events.md) (e.g. "repeat event daily") you'll need to implement a couple of extra steps.
...
Finally, you'll need to [update the storage](guides/recurring-events.md#editingdeleting-a-certain-occurrence-in-the-series).
...
In case you've completed the above steps to implement Scheduler integration with Node.js, but Scheduler doesn't render events on a page, have a look at the [Troubleshooting Backend Integration Issues](guides/troubleshooting.md) article. It describes
