---
title: "dhtmlxScheduler with Ruby on Rails"
...
At this point you can specify a view for the "home" controller that was created at the [Step 2](integrations/other/howtostart-ruby.md). 
...
You can find the list of mandatory properties of the Event object with their descriptions in the [corresponding article](guides/loading-data.md#data-properties) of documentation.
...
There's a [common technique](guides/server-integration.md#technique) for loading data into Scheduler from the server side.

You will find the requirements to the client side, as well as the [description of possible requests and responses](guides/server-integration.md#request-parameters) in the [Server-Side Integration](guides/server-integration.md) article.
...
As you can see, an event appeared in the scheduler. You have added it at the [Step 6](integrations/other/howtostart-ruby.md#step-6-creating-models). Now you can add more events and modify them. All the changes will be saved in the database.
...
In case you've completed the above steps to implement Scheduler integration with Ruby on Rails, but Scheduler doesn't render events on a page, have a look at the [Troubleshooting Backend Integration Issues](guides/troubleshooting.md) article. It describes 
