...
description: "returns a collection of events which occur during the specified period"
---
...
@short: Returns a collection of events which occur during the specified period
...
If support for [recurring events](guides/recurring-events.md) is activated, the behavior of the **getEvents** method depends on whether "from-to" parameters are specified. 
