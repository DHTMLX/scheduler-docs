...
title: "locale config"
description: "a locale object (region-specific labels) of the scheduler"
---
...
Both approaches are valid and supported. We recommend using the [scheduler.i18n](api/other/i18n.md) object API.
