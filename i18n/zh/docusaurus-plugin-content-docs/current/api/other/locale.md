...
当前的 locale 可以通过 **scheduler.locale** 对象访问，并且可以直接更新，如下所示:
...
这两种方法都有效且被支持。建议使用 [scheduler.i18n](api/other/i18n.md) API 来管理本地化。
