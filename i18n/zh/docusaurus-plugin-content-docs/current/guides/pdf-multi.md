...
+ _**path**_ - (_url_) 负责生成 PDF 的 PHP 文件的 URL。更多详情请参考章节 ['Export to PDF. Configuring service'](export/pdf.md#server-side)
...
2. '_gray_' - 以灰度方式导出
3. '_bw_' - 仅使用黑白导出
4. '_custom_' - 允许自定义配色（需要 PHP 定制，详情请参见章节 ['Export to PDF. Configuring service'](export/pdf.md#server-side)）
