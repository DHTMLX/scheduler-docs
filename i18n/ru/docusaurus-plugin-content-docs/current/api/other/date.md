...
~~~js
//добавляет 1 год к указанной дате: 29 июня 2026 -> 29 июня 2027
const newDate = scheduler.date.add(new Date(2026, 05, 29), 1, 'year');
~~~
...
~~~js
const copy = scheduler.date.copy(new Date(2027, 05, 29)); // -> 29 июня 2027
~~~
...
~~~js
//29 июня 2027 14:30 -> 24 июня 2027 00:00
...
~~~js
//29 июня 2027 14:30 -> 01 января 2027 00:00
