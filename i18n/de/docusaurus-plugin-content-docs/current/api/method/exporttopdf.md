...
<table class="webixdoc_links">
  ...
  <td>(<i>string</i>) die URL des API-Endpunkts, der die Exportanfrage verarbeitet. Dies kann auf einen lokalen Exportdienst verweisen. Standard ist `https://export.dhtmlx.com/scheduler`</td>
  </tr>
  <tr>
