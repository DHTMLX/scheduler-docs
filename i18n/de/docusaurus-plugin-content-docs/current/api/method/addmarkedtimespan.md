...
description: "Markiert Datumsangaben, aber unter bestimmten Einstellungen wird eine Blockierung ermöglicht (das Festlegen eines benutzerdefinierten Stils für das Limit ist möglich)"
---
...
@short: Markiert Datumsangaben, aber bei bestimmten Einstellungen führt dies zu einer Blockierung (das Festlegen eines benutzerdefinierten Stils für das Limit ist möglich)
...
Hinweis: Das Markieren (Blocking) wird nicht direkt nach dem Aufruf der Methode angewendet. Sie sollten [`updateView()`](api/method/updateview.md) aufrufen, um die Markierung anzuwenden.
...
the time span(s) exists all time along
 ...
 der Zeitraum existiert dauerhaft
</td></tr>
<tr><td>
