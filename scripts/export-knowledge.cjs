...
/**
 * Export Docusaurus docs into a single text file for ChatGPT Project Sources/Knowledge base.
 *
 * Output format:
 *
 ...
 *   node scripts/export-knowledge.cjs --out ./tmp/scheduler-guides.txt
 *   node scripts/export-knowledge.cjs --keep-frontmatter
 *
 * Recommended:
 *   node scripts/export-knowledge.cjs --exclude-api --out ./tmp/scheduler-guides.txt
 *   node scripts/export-knowledge.cjs --api-only --out ./tmp/scheduler-api.txt
 */
